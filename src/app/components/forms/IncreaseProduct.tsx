'use client'
import { createProduct, increaseStock } from '@/app/api/products'
import Button from '@mui/material/Button'
import React, { useEffect, useState } from 'react'
interface Props {

    increase: (value: boolean) => void,
    selectedProduct: Product | null;
}

const IncreaseProduct = ({ selectedProduct, increase }: Props) => {
        ...
        <div className="fixed inset-0 flex items-center justify-center  bg-opacity-50 backdrop-blur-md z-50 ">
            ...
            <div className='bg-white'>
                <form onSubmit={handleSubmit} className="  flex flex-col  items-center justify-center space-y-4  p-6 rounded-2xl   ">
                    ...
                    <div className="flex w-full flex-col">
                        <h1>Number of Increase Stock</h1>
                        <input
                            type="number"
                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <Button onClick={() => increase(false)} style={{ padding: '10px', flex: 1 }} color='error' variant="contained">
                            Cancel
                        </Button>
